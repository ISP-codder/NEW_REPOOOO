...
async function notificationTemplate(data, photos) {
	...
	const requirements = [
		...
		`Сумму компенсации (${data.compensationAmount} к.) и досудебную компенсацию (${data.preTrialCompensation} к.) возможно оплатить посредством перевода по QR-коду, предоставленному правообладателем (его представителем). Оплата по QR-коду признается надлежащим исполнением денежного обязательства при условии поступления средств в полном объеме.`
	]
